        ...
        <div className="w-full">
            <div>
                <div className="mt-24 sm:mt-32 md:mt-40 lg:mt-[231px] flex flex-col gap-2 text-center px-4">
                    ...
                    >
                        A considered home for research—written with care,
                        reviewed with rigor,
                ...
                >
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto rounded-full bg-brand-gray px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base text-white dark:bg-brand-gray dark:text-white"
                    >
                        Explore researches
                    </button>
                </div>
